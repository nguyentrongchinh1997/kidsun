		                ...
		                <div class="tab-content">
		                    <div class="tab-pane active" id="activity">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name_bank" id="name" value="{{ old('name_bank') }}">
								</div>
								<div class="form-group">
									<label for="">Tên chủ tài khoản</label>
									<input type="text" class="form-control" name="name_account" value="{{ old('name_account') }}">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="custom-checkbox">
										<input type="checkbox" class="category" name="status" value="1" checked>
										Hiển thị trang chủ
	                                </label>
								</div>								
